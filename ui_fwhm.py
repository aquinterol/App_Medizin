...
# Form implementation generated from reading ui file 'fwhm.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.F_title.setGeometry(QtCore.QRect(220, 30, 221, 31))
        self.F_title.setStyleSheet("color: rgb(0, 0, 127);\n"
"font: 14pt \"Segoe UI\";")
        self.F_title.setObjectName("F_title")
        self.frame = QtWidgets.QFrame(Form)
        self.frame.setGeometry(QtCore.QRect(40, 90, 541, 491))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 541, 491))
    ...
    def retranslateUi(self, Form):
        ...
        self.F_title.setText(_translate("Form", "FWHM Values"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Point No. "))
