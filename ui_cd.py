...
"font: 16pt \"Segoe UI\";")
        ...
        self.combbprincipal.setGeometry(QtCore.QRect(40, 140, 471, 28))
...
"}")
        ...
        self.Frame2.setGeometry(QtCore.QRect(730, 190, 701, 661))
        self.Frame2.setObjectName("Frame2")
        self.Frame1 = QtWidgets.QWidget(Form)
        self.Frame1.setGeometry(QtCore.QRect(10, 190, 701, 661))
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(1200, 120, 221, 28))
    ...
    def retranslateUi(self, Form):
        ...
        self.combbprincipal.setItemText(1, _translate("Form", "3D Visualization - Isosurface"))
        self.combbprincipal.setItemText(2, _translate("Form", "Axes "))
        ...
        self.comboBox_2.setItemText(0, _translate("Form", "Milimeters"))
        self.comboBox_2.setItemText(1, _translate("Form", "Wavelength "))
